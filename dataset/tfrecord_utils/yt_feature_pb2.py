...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='yt_feature.proto',
  package='youtu_tf',
  syntax='proto3',
  serialized_pb=_b('\n\x10yt_feature.proto\x12\x08youtu_tf\"\x1a\n\tBytesList\x12\r\n\x05value\x18\x01 \x03(\x0c\"\x1e\n\tFloatList\x12\x11\n\x05value\x18\x01 \x03(\x02\x42\x02\x10\x01\"\x1e\n\tInt64List\x12\x11\n\x05value\x18\x01 \x03(\x03\x42\x02\x10\x01\"\x92\x01\n\x07\x46\x65\x61ture\x12)\n\nbytes_list\x18\x01 \x01(\x0b\x32\x13.youtu_tf.BytesListH\x00\x12)\n\nfloat_list\x18\x02 \x01(\x0b\x32\x13.youtu_tf.FloatListH\x00\x12)\n\nint64_list\x18\x03 \x01(\x0b\x32\x13.youtu_tf.Int64ListH\x00\x42\x06\n\x04kind\"\x7f\n\x08\x46\x65\x61tures\x12\x30\n\x07\x66\x65\x61ture\x18\x01 \x03(\x0b\x32\x1f.youtu_tf.Features.FeatureEntry\x1a\x41\n\x0c\x46\x65\x61tureEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12 \n\x05value\x18\x02 \x01(\x0b\x32\x11.youtu_tf.Feature:\x02\x38\x01\"1\n\x0b\x46\x65\x61tureList\x12\"\n\x07\x66\x65\x61ture\x18\x01 \x03(\x0b\x32\x11.youtu_tf.Feature\"\x98\x01\n\x0c\x46\x65\x61tureLists\x12=\n\x0c\x66\x65\x61ture_list\x18\x01 \x03(\x0b\x32\'.youtu_tf.FeatureLists.FeatureListEntry\x1aI\n\x10\x46\x65\x61tureListEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12$\n\x05value\x18\x02 \x01(\x0b\x32\x15.youtu_tf.FeatureList:\x02\x38\x01\x42\x03\xf8\x01\x01\x62\x06proto3')
)
...
_BYTESLIST = _descriptor.Descriptor(
  name='BytesList',
  full_name='youtu_tf.BytesList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='youtu_tf.BytesList.value', index=0,
...
_FLOATLIST = _descriptor.Descriptor(
  name='FloatList',
  full_name='youtu_tf.FloatList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='youtu_tf.FloatList.value', index=0,
...
_INT64LIST = _descriptor.Descriptor(
  name='Int64List',
  full_name='youtu_tf.Int64List',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='youtu_tf.Int64List.value', index=0,
...
_FEATURE = _descriptor.Descriptor(
  name='Feature',
  full_name='youtu_tf.Feature',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bytes_list', full_name='youtu_tf.Feature.bytes_list', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='float_list', full_name='youtu_tf.Feature.float_list', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int64_list', full_name='youtu_tf.Feature.int64_list', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='kind', full_name='youtu_tf.Feature.kind',
...
_FEATURES_FEATUREENTRY = _descriptor.Descriptor(
  name='FeatureEntry',
  full_name='youtu_tf.Features.FeatureEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='youtu_tf.Features.FeatureEntry.key', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='youtu_tf.Features.FeatureEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURES = _descriptor.Descriptor(
  name='Features',
  full_name='youtu_tf.Features',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature', full_name='youtu_tf.Features.feature', index=0,
...
_FEATURELIST = _descriptor.Descriptor(
  name='FeatureList',
  full_name='youtu_tf.FeatureList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature', full_name='youtu_tf.FeatureList.feature', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURELISTS_FEATURELISTENTRY = _descriptor.Descriptor(
  ...
  full_name='youtu_tf.FeatureLists.FeatureListEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='youtu_tf.FeatureLists.FeatureListEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='youtu_tf.FeatureLists.FeatureListEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURELISTS = _descriptor.Descriptor(
  name='FeatureLists',
  full_name='youtu_tf.FeatureLists',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature_list', full_name='youtu_tf.FeatureLists.feature_list', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
BytesList = _reflection.GeneratedProtocolMessageType('BytesList', (_message.Message,), dict(
  ...
  __module__ = 'yt_feature_pb2'
  # @@protoc_insertion_point(class_scope:youtu_tf.BytesList)
  ))
...
FloatList = _reflection.GeneratedProtocolMessageType('FloatList', (_message.Message,), dict(
  ...
  __module__ = 'yt_feature_pb2'
  # @@protoc_insertion_point(class_scope:youtu_tf.FloatList)
  ))
...
Int64List = _reflection.GeneratedProtocolMessageType('Int64List', (_message.Message,), dict(
  ...
  __module__ = 'yt_feature_pb2'
  # @@protoc_insertion_point(class_scope:youtu_tf.Int64List)
  ))
...
Feature = _reflection.GeneratedProtocolMessageType('Feature', (_message.Message,), dict(
  DESCRIPTOR = _FEATURE,
  __module__ = 'yt_feature_pb2'
  # @@protoc_insertion_point(class_scope:youtu_tf.Feature)
  ))
...
Features = _reflection.GeneratedProtocolMessageType('Features', (_message.Message,), dict(
  ...
  FeatureEntry = _reflection.GeneratedProtocolMessageType('FeatureEntry', (_message.Message,), dict(
    ...
    __module__ = 'yt_feature_pb2'
    # @@protoc_insertion_point(class_scope:youtu_tf.Features.FeatureEntry)
    ))
  ,
  DESCRIPTOR = _FEATURES,
  __module__ = 'yt_feature_pb2'
  # @@protoc_insertion_point(class_scope:youtu_tf.Features)
  ))
...
FeatureList = _reflection.GeneratedProtocolMessageType('FeatureList', (_message.Message,), dict(
  ...
  __module__ = 'yt_feature_pb2'
  # @@protoc_insertion_point(class_scope:youtu_tf.FeatureList)
  ))
...
FeatureLists = _reflection.GeneratedProtocolMessageType('FeatureLists', (_message.Message,), dict(
  ...
  FeatureListEntry = _reflection.GeneratedProtocolMessageType('FeatureListEntry', (_message.Message,), dict(
    ...
    __module__ = 'yt_feature_pb2'
    # @@protoc_insertion_point(class_scope:youtu_tf.FeatureLists.FeatureListEntry)
    ))
  ,
  DESCRIPTOR = _FEATURELISTS,
  __module__ = 'yt_feature_pb2'
  # @@protoc_insertion_point(class_scope:youtu_tf.FeatureLists)
  ))
