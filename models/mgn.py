...
class MGN(nn.Module):
    def __init__(self, class_num=1000):
        ...
        self.p3 = nn.Sequential(copy.deepcopy(res_conv4), copy.deepcopy(resnet.layer4))
...
class MGN_Resnext(nn.Module):
    def __init__(self, class_num=1000):
        super(MGN_Resnext, self).__init__()
        num_classes = class_num
