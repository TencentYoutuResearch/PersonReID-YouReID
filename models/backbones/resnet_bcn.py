...
model_urls = {
    ...
    'resnet101': 'https://download.pytorch.org/models/rn101_bcn_ws.pth',
}
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes,
        ...
        self.conv1 = Conv2d(inplanes, width, kernel_size=1, bias=False)
        ...
        self.conv3 = Conv2d(width, planes * self.expansion, kernel_size=1, bias=False)
...
def resnet50_bcn(pretrained=False, last_stride=1, use_non_local=False, model_path=''):
...
def resnet101_bcn(pretrained=False, last_stride=1, use_non_local=False, model_path=''):
    """Constructs a ResNet-50 model.
